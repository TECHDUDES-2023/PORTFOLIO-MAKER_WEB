...
<html lang="en">
    <head>
        ...
        <title>Noah | Portfolio Maker</title>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-lg-flex align-items-center d-none ms-auto">
                        <input type="submit" class="custom-btn btn" name="noah" value="Use this template">
                        <a href="../../design-templates.php" class="custom-btn btn"> EXIT</a>
                    </div>
                </div>
            </div>
        </nav>
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    ...
                                    <input type="text" class="hero-title ms-3 mb-0" value="Hi I'm Noah" name="d1" style="font-size: 44px; letter-spacing: -3px; font-weight: var(--font-weight-bold); width:50%;">
