...
<!---
                    <li class="nav-item">
                        <a class="- btn btn-primary rounded ml-4" href="components.php">Components</a>
                    </li>

                    --->

                    <li>
                        <input type="submit" class="- btn btn-primary rounded ml-4" name="save" value="Save">
                    </li>
    ...
    <header class="header" id="home">
        <div class="container">
            <div class="infos">
                <input type="text" class="subtitle" value="Hello Im">
                <input type="text" class="title" value="John Smith" style="border: none;">
        ...
        <div class="widget">
            <div class="widget-item">
                <input type="text" class="h2" value="123" style="margin: 0; text-align: center; width: 50%;">
                <input type="text" class="p" value="Happy Clients" style="text-align: center; opacity: 7; font-size: 14px; letter-spacing: .6px; font-weight: 400; line-height: 1.5; color: #495057;">
            </div>
            <div class="widget-item">
                <input type="text" class="h2" value="521" style="margin: 0; text-align: center; width: 50%;">
                <input type="text" class="p" value="Project Completed" style="text-align: center; opacity: 7; font-size: 14px; letter-spacing: .6px; font-weight: 400; line-height: 1.5; color: #495057;">
            </div>
            <div class="widget-item">
                <input type="text" class="h2" value="121" style="margin: 0; text-align: center; width: 50%;">
                <input type="text" class="p" value="Awards Won" style="text-align: center; opacity: 7; font-size: 14px; letter-spacing: .6px; font-weight: 400; line-height: 1.5; color: #495057;">
            </div>
        </div>
    </header>
    <!-- End of Page Header -->
        ...
        <div class="container mt-5">
            <div class="row text-center text-md-left">
                ...
                <div class="pl-md-4 col-md-9">
                    <input type="text" class="title" value="James Smith">
                    <input type="text" class="subtitle" value="UI/UX DESIGNER" style="display: block;">
                    <input type="text" class="p" style="letter-spacing: .6px; display: block; width: 100%; font-weight: 400; line-height: 1.5 ; color: #495057;" value="Lorem ipsum dolor sit amet, consectetur adOdio ducimus depni magnam.">
                    <input type="text" class="p" style="letter-spacing: .6px; display: block; width: 100%; font-weight: 400; line-height: 1.5 ; color: #495057;" value="Lorem ipsum dolor sit amet, consectetur adOdio ducimus depni magnam.">
                    <input type="text" class="p" style="letter-spacing: .6px; display: block; width: 100%; font-weight: 400; line-height: 1.5 ; color: #495057;" value="Lorem ipsum dolor sit amet, consectetur adOdio ducimus depni magnam.">
                    <input type="text" class="p" style="letter-spacing: .6px; display: block; width: 100%; font-weight: 400; line-height: 1.5 ; color: #495057;" value="Lorem ipsum dolor sit amet, consectetur adOdio ducimus depni magnam.">
    ...
    <section id="service" class="section">
        <div class="container text-center">
            <input type="text" class="subtitle" value="Service" style="font-size: 15px; opacity: .8; margin-bottom: 5px; font-weight: 500; line-height: 1.2; margin-top: 0;     display: block;
            font-size: 1rem;
