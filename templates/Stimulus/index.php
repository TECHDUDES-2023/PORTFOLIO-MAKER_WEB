          ...
          <div class="collapse navbar-collapse">
               <form action="" method="POST">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><input type="submit" class="wow fadeInUp smoothScroll section-btn btn btn-success" name="stimulus" value="Use this template" style="margin-top: 7px;"></li>
                         <li><a href="../../design-templates.php" class="wow fadeInUp smoothScroll section-btn btn btn-success" style="margin-top: 7px; width:auto; height:50px; padding-top:1px;"> EXIT</a></li>
