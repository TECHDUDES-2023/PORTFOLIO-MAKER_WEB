        ...
        <div class="signin-signup">
          <form action="new-password.php" class="sign-in-form" method="POST" autocomplete="off">
            ...
            <div class="input-field">
              ...
              <input type="password" class="input" name="password" required placeholder="Create new password">
            </div>
            ...
            <input type="submit" value="Change" class="btn solid" name="change-password" style="width: 350px;">         
          </form>
        </div>
